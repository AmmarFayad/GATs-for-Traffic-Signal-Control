...
class TrafficGenerator:
    ...
    def generate_routefile(self, seed):
        ...
        with open("intersection/7intersection/network.rout.xml", "w") as routes:
            print("""<routes>
                    <vType accel="1.0" decel="4.5" id="standard_car" length="5.0" minGap="2.5" maxSpeed="25" sigma="0.5" />
                    
                    <route id="0"  edges="A1B1 B1C1 C1D1 D1E1 E1F1 F1G1 G1H1 H1I1" />
                    <route id="1"  edges="I1H1 H1G1 G1F1 F1E1 E1D1 D1C1 C1B1 B1A1" />
                    <route id="2"  edges="B2B1 B1B0" />
                    <route id="3"  edges="B0B1 B1B2" />
                    <route id="4"  edges="C2C1 C1C0" />
                    <route id="5"  edges="D2D1 D1D0" />
                    <route id="6"  edges="E2E1 E1E0" />
                    <route id="7"  edges="F2F1 F1F0" />
                    <route id="8"  edges="G2G1 G1G0" />
                    <route id="9"  edges="H2H1 H1H0" />
        ...
        #     """, file=routes)
            ...
            for car_counter, step in enumerate(car_gen_steps):
                ...
                if True:
                    ...
                    route_straight = np.random.randint(0, 10)
