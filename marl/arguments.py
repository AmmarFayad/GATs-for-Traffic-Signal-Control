...
def get_args():
    ...
    #algo
    parser.add_argument('--algo-paradigm', default='Interaction-Graph', help='Baseline or not?')
    #Interaction-Graph
    # traffic simulator
    parser.add_argument('--gui', action='store_true', help='render simulations')
    parser.add_argument('--total-episodes', type=int, default=1000)
    parser.add_argument('--max-steps', type=int, default=7000)
    parser.add_argument('--n-cars-generated', type=int, default=1000)
    parser.add_argument('--green-duration', type=int, default=10)#30 30 4 4
    parser.add_argument('--yellow-duration', type=int, default=4)
    

    # environment
    parser.add_argument('--env-name', default='graph-atl', help='one from {graph-atl)')
    parser.add_argument('--num-agents', type=int, default=7)
    parser.add_argument('--num-actions', type=int, default=2)
    parser.add_argument('--obs-size', type=int, default=40)
    ...
    parser.add_argument('--num-steps', type=int, default=500, help='number of forward steps in PPO (default: 128)')
    ...
    parser.add_argument('--test-run', action='store_true', help='no gradient updates')
